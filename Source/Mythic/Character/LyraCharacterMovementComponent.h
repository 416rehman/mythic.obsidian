...
MYTHIC_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);
 ...
 */
UCLASS(Config = Game)
class MYTHIC_API ULyraCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

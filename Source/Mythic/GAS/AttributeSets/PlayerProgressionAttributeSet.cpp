#include "PlayerProgressionAttributeSet.h"

#include "Mythic/GAS/ASCMythic_Player.h"
#include "GameplayEffectExtension.h"
#include "Net/UnrealNetwork.h"

void UPlayerProgressionAttributeSet::OnRep_XP(const FGameplayAttributeData& OldValue) {
	GAMEPLAYATTRIBUTE_REPNOTIFY(UPlayerProgressionAttributeSet, XP, OldValue);
}

void UPlayerProgressionAttributeSet::OnRep_Level(const FGameplayAttributeData& OldValue) {
	GAMEPLAYATTRIBUTE_REPNOTIFY(UPlayerProgressionAttributeSet, Level, OldValue);
}

void UPlayerProgressionAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME_CONDITION_NOTIFY(UPlayerProgressionAttributeSet, XP, COND_None, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UPlayerProgressionAttributeSet, Level, COND_None, REPNOTIFY_Always);
}

void UPlayerProgressionAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data) {

...
#include "MythicAttributeSet_Player.generated.h"

UCLASS()
class MYTHIC_API UMythicAttributeSet_Player: public UMythicAttributeSet {
    GENERATED_BODY()
protected:
...
public:
    GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UMythicAttributeSet_Player, MaxHealth);
    GAMEPLAYATTRIBUTE_VALUE_GETTER(MaxHealth);
    GAMEPLAYATTRIBUTE_VALUE_SETTER(MaxHealth);
    GAMEPLAYATTRIBUTE_VALUE_INITTER(MaxHealth);
    
    GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UMythicAttributeSet_Player, Health);
    GAMEPLAYATTRIBUTE_VALUE_GETTER(Health);
    GAMEPLAYATTRIBUTE_VALUE_SETTER(Health);
    GAMEPLAYATTRIBUTE_VALUE_INITTER(Health);

    GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UMythicAttributeSet_Player, MovementSpeed);

...
class MYTHIC_API ULyraReplayListEntry : public UObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class MYTHIC_API ULyraReplayList : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class MYTHIC_API ULyraReplaySubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()

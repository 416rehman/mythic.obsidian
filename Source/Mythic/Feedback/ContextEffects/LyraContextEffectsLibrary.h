...
struct MYTHIC_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MYTHIC_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class MYTHIC_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()

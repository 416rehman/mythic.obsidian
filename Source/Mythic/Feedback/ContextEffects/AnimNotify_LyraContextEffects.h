...
struct MYTHIC_API FLyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MYTHIC_API FLyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MYTHIC_API FLyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct MYTHIC_API FLyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class MYTHIC_API UAnimNotify_LyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()

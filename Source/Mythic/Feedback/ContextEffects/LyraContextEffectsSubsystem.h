...
class MYTHIC_API ULyraContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MYTHIC_API ULyraContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MYTHIC_API ULyraContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()

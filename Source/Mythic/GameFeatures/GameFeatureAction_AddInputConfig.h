...
class UE_DEPRECATED(5.3, "UGameFeatureAction_AddInputConfig has been deprecated. Please use UGameFeatureAction_AddInputContextMapping instead.") MYTHIC_API UGameFeatureAction_AddInputConfig : public UGameFeatureAction_WorldActionBase
{
	GENERATED_BODY()

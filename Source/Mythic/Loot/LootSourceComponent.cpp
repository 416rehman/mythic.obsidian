...
#include "LootSourceComponent.h"
#include "LootManagerSubsystem.h"
#include "LootSourceDA.h"
#include "LootTable.h"
#include "GameFramework/PlayerState.h"
#include "Mythic/Inventory/ItemDefinition.h"
#include "Mythic/GAS/AttributeSets/PlayerProgressionAttributeSet.h"


// Sets default values for this component's properties
ULootSourceComponent::ULootSourceComponent() {
...
void ULootSourceComponent::BeginPlay() {
    Super::BeginPlay();

    this->LootManager = GetOwner()->GetGameInstance()->GetSubsystem<ULootManagerSubsystem>();
}

void ULootSourceComponent::SetLootSource(ULootSourceDA *NewLootSource) {
...
// void ULootSourceComponent::RequestLoot(UAbilitySystemComponent *AbilitySystemComponent, ELootType Type) {
//     // Authority check
...
//     // Get Current XP
//     bool bFound;
//     auto PlayerExp = AbilitySystemComponent->GetGameplayAttributeValue(UPlayerProgressionAttributeSet::GetXPAttribute(), bFound);
//
...
//         TArray<AWorldItem *> SpawnedItems;
//
...
//                 bool AlreadySpawned = SpawnedItems.ContainsByPredicate([&TableEntry](AWorldItem *Item) {
...
//                     AWorldItem *world_item = this->LootManager->CreateAndSpawn(TableEntry.ItemClass, stackSize, this->GetOwner()->GetActorLocation(),

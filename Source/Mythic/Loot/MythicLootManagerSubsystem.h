...
public:
    ...
    // Create a new loot item and give it to a player. If not stackable, only one item will be given. If the player's inventory is full, a world item will be spawned and returned.
    UFUNCTION(BlueprintCallable)

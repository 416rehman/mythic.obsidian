...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_STATE_MOVING);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE_FIRSTSTRIKE);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE_RIPOSTE);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE_SLAM);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE_DEBT);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_RUNE_TOLL);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_HIT_FALL);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_EVENT_MOVED);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_EVENT_CURRENCY_SPENT);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(GAS_EVENT_HARVEST_STRUCK);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(HARVEST_FELLED);

...
public:
    ...
    UFUNCTION()
    void OnObstacleOverlapped(UPrimitiveComponent *PrimitiveComponent, AActor *Actor, UPrimitiveComponent *PrimitiveComponent1, int I, bool bArg,
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Destination Based Navigation",
        meta=(AllowPrivateAccess = "true", ClampMin = "0.0", ClampMax = "1000.0", EditCondition = "bUseObstacleAvoidance"))

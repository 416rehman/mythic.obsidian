...
void UAffixesFragment::RollAffixes(int ItemLevel, int Qty) {
    ...
    if (AffixesAdded < ClampedQty && AffixPoolMap.Num() >= ClampedQty) {
        ...
        for (auto &AffixKey : AffixKeys) {
            ...
            this->AffixesRuntimeReplicatedData.RolledAffixes.Add(FRolledAttributeSpec(Attribute, ItemLevel, RollDef));
...
bool UAffixesFragment::IsAffixRolled(const FGameplayAttribute &Affix, TArray<FRolledAttributeSpec> &RolledAffixes) {
...
void UAffixesFragment::RollCoreAffixes(int ItemLevel) {
    ...
    for (auto &CoreStat : CoreAffixes) {
        ...
        this->AffixesRuntimeReplicatedData.RolledCoreAffixes.Add(FRolledAttributeSpec(Attribute, ItemLevel, RollDef));
    }
}
...
void UAffixesFragment::ApplyAffixes(UAbilitySystemComponent *ASC, TArray<FRolledAttributeSpec> &InRolledAffixes) {
...
void UAffixesFragment::RemoveAffixes(UAbilitySystemComponent *ASC, TArray<FRolledAttributeSpec> &InRolledAffixes) {
    for (auto &Roll : InRolledAffixes) {
        if (!Roll.Attribute.IsValid()) {

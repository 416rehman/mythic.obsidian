...
UE_DEFINE_GAMEPLAY_TAG(ITEMIZATION_STATION_FIREPLACE, "Itemization.Station.Fireplace");
UE_DEFINE_GAMEPLAY_TAG(ITEMIZATION_STATION_ALCHEMYTABLE, "Itemization.Station.AlchemyTable");
...
UE_DEFINE_GAMEPLAY_TAG(ITEMIZATION_PROCESS_BREW, "Itemization.Process.Brew");
...
UE_DEFINE_GAMEPLAY_TAG(INVENTORY_GROUP_STATION_OUTPUT, "Inventory.Group.Station.Output");
